...
-/
lemma is_min_on_of_is_local_min_on_of_convex_on {f : E → ℝ} {a : E}
...
lemma is_min_on_of_is_local_min_on_of_convex_on' {f : E → ℝ} {a : E}
  ...
  is_min_on f s a :=
begin
  dsimp [is_min_on, is_min_filter],
  rw[eventually_principal],
  exact is_min_on_of_is_local_min_on_of_convex_on as h_local_min h_conv
end

/-
A local minimum of a convex function is a global minimum
-/
lemma is_min_of_is_local_min_of_convex {f : E → ℝ} {a : E}
  (h_local_min : is_local_min f a) (h_conv : convex_on univ f) :
  ∀ x, f a ≤ f x :=
